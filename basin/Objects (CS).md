A self-contained entity combining **data** and **behavior**. The data is often referred to as a field or property, while the behavior goes by [[Method|method]] or [[Function (CS)|function]]. 
